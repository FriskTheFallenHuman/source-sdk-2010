...
public:
	...
	virtual int					FPrintf(FileHandle_t file, const char* pFormat, ...) FMTFUNCTION(3, 4);
	...
	// Console/DVD only stuff? We will never need this
	virtual bool				IsLaunchedFromXboxHDD() { return false; }
	virtual bool				IsInstalledToXboxHDDCache() { return false; }
	virtual bool				IsDVDHosted() { return false; }
	virtual bool				IsInstallAllowed() { return false; }
